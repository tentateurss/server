...
public class MainMenuGUI {
    ...
    public static void open(Player player) {
        ...
        inv.setItem(SLOT_PERKS, createMenuItem(
            ...
            "§6§lДерево перков (web)",
            "§7Прокачка пассивных узлов",
            "",
            "§8• §7Открывается в браузере",
            "§8• §7Полная синхронная прокачка",
            "§8• §7Все статы применяются мгновенно",
            "",
            "§eНажмите — получить ссылку и код"
        ));
